        ...
        <div class="col-xl-10 col-lg-15 col-md-9">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block"><img src="https://i.ibb.co/7r3xmmF/logo-sirmpo.png" style="width:480px;height:500px;"></div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <!-- <h1 class="h4 text-gray-900 mb-4">Selamat Datang !</h1> -->
                                    <h4 class="h6 text-gray-900 mb-4">Silahkan Login</h4>
                                </div>
